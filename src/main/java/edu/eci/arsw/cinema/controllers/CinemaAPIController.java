...
public class CinemaAPIController {
	...
	@RequestMapping(method = RequestMethod.POST, value = "/{cinema}/{date}/{movieName}/{row}/{col}")
	public ResponseEntity<?> manejadorPutSeatTicket(@PathVariable String cinema, @PathVariable String date,
			@PathVariable String movieName, @PathVariable String row, @PathVariable String col) {
		try {
			cinemaService.buyTicket(Integer.parseInt(row), Integer.parseInt(col), cinema, date, movieName);
